...
from mediApp.views import post, gotoNew, addPost, gotoRecord, gotoAllpost, findMed, gotoIndex, gotoNewUser, gotoMake, gotoMode, gotoSickChoose, addUser, keyInfo,login,signout
